...
if __name__ == "__main__":
    ...
    about = {}
    with open(os.path.join(src_dir, "vivarium_workshop_ndbs", "__about__.py")) as f:
        exec(f.read(), about)
    ...
    setup(
        ...
        zip_safe=False,
        use_scm_version={
            "write_to": "src/vivarium_workshop_ndbs/_version.py",
        ...
        entry_points="""
            [console_scripts]
            make_artifacts=vivarium_workshop_ndbs.tools.cli:make_artifacts
        """,
    )
