...
from vivarium_workshop_ndbs.constants import data_keys, metadata
from vivarium_workshop_ndbs.tools.app_logging import add_logging_sink, decode_status
from vivarium_workshop_ndbs.utilities import sanitize_location
...
def build_single_location_artifact(
    ...
    from vivarium_workshop_ndbs.data import builder
